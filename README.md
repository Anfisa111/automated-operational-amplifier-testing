...
scripts/op_test3.py — основной скрипт проведения эксперимента.  
logs/ — логи.  
...
`python -m scripts.op_test3.py` 

## Пример вывода
После завершения цикла измерений программа построит график и выведет отчет:  
Средняя частота единичного усиления $f_T$: 1.0615 МГц.  
Доверительный интервал (P=0.95): ±97.10 кГц.  
Результат: f_T = 1.0615 ± 0.0971 МГц 

<p align="center">
  <img src="docs/img/bode_plot.png" alt="График АЧХ" width="600">
</p>
